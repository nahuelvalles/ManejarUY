...
const List<PreguntaExamen> preguntasExamen = [
  ...
  PreguntaExamen(
    pregunta: '¿La calle es el tramo de la vía pública destinado preferentemente a?',
    opciones: [
  ...
  PreguntaExamen(
    pregunta: '¿Con el coche cargado las distancias para detenerse serán menores?',
    opciones: [
      'Verdadero',
      'Falso',
    ],
  ...
  PreguntaExamen(
    pregunta: '¿Por norma general usted tiene que circular por la izquierda de la calzada?',
    opciones: [
      'Verdadero',
      'Falso',
    ],
  ...
  PreguntaExamen(
    pregunta: '¿Un conductor al enfrentar una señal de "Ceda el Paso" tiene que?',
    opciones: [
      'Detenerse siempre',
  ...
  PreguntaExamen(
    pregunta: '¿Se puede adelantar a un vehículo que está doblando a la derecha?',
    opciones: [
      'Verdadero',
      'Falso',
    ],
  ...
  opciones: [
    'En la mitad de la cuadra',
    'En la acera derecha de las calles de doble sentido',
    'En la puerta de una escuela',
    'A menos de 10 metros de una señal de "PARE" o "CEDA EL PASO"',
    'En los canteros centrales. f) En ángulo con el cordón. g) Las respuestas d, e y f son correctas',
  ],
  respuestaCorrecta: 0,
),
PreguntaExamen(
...
PreguntaExamen(
  pregunta: '¿Qué tiene que hacer un conductor al estacionar un vehículo motorizado?',
  opciones: [
